...
VL_INLINE_OPT void Vmd5::_sequent__TOP__1(Vmd5__Syms* __restrict vlSymsp) {
    ...
    if ((0U == (IData)(vlTOPp->md5__DOT__r_r))) {
        vlTOPp->md5__DOT__round__DOT__add_res = (((vlTOPp->md5__DOT__r_a 
                                                   + 
        ...
        if ((1U == (IData)(vlTOPp->md5__DOT__r_r))) {
            vlTOPp->md5__DOT__round__DOT__add_res = 
                (((vlTOPp->md5__DOT__r_a + vlTOPp->md5__DOT__round__DOT__FGHI[1U]) 
...
void Vmd5::_ctor_var_reset() {
    ...
    md5__DOT__round__DOT__add_res = VL_RAND_RESET_I(32);
